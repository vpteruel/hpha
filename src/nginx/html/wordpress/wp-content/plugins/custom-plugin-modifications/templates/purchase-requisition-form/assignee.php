...
<div class="container">
    <div class="header">
        <h1>Purchase Requisition Pending Approval</h1>
    </div>
    <div class="content">
        <p>Dear Approver,</p>
        <p>A purchase requisition is awaiting your approval. Please review the details below:</p>
        ...
        <div class="link">
            <p>Please <a href="{workflow_entry_url}">click here</a> to review and approve the requisition.</p>
        </div>
    </div>
</div>
